...
public class GraphToolBar extends JPanel
{
  ...
  public GraphToolBar()
  {
    ...
    image1 = new ImageIcon(TuringMachine.TuringMachineFrame.class.getResource("select.gif"));
    image2 = new ImageIcon(TuringMachine.TuringMachineFrame.class.getResource("insertstate.gif"));
    image3 = new ImageIcon(TuringMachine.TuringMachineFrame.class.getResource("insertedge.gif"));
